...
class LambdaIAMStack(NestedStack):
    def __init__(self, scope: Construct, id: str, healthlake_datastore_id=None, healthlake_datastore_arn=None,kms_key=None, resource_prefix: str = None, **kwargs) -> None:
        ...
        my_lambda1 = lambda_.Function(
            ...
            #code = lambda_.Code.from_asset("/Users/bpinaki/Documents/HCLS/TFC/aws-dcm2fhir-project/aws_dcm2fhir_project/lambda_manageconfig"),
            role=lambda_role,
