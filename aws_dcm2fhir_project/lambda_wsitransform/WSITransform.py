...
#build a transform code to generate a FHIR JSON file as referred above from the DICOM metadata structure mapped from a .dcm file
import pydicom
import json
...
def create_series_structure(metadata):
    try:
        """Create series structure for FHIR data"""
        ...
        return [{
            ...
            "modality": {
                ...
                #"description" : str_description, #replace-1 with SeriesDescription
